      ...
      const commands = {
          serve: (options) => {
            return new Promise((resolve, reject) => {
              ...
              executeShellCommand(`rm -rf "${debugPath}"; mkdir "${debugPath}" ; node "${browserifyPath}" ${mainPath} > "${debugPath}/index.js" ; cp "${dirPath}/index.html" "${debugPath}/index.html"`, (stdout) => {
                console.log(`----------------------------------------`);
          ...
          build: (options) => {
            return new Promise((resolve, reject) => {
              ...
              executeShellCommand(`rm -rf "${buildPath}"; mkdir "${buildPath}" ; node "${browserifyPath}" "${mainPath}" > "${buildPath}/index.js"; node "${minifyPath}" "${buildPath}/index.js" > "${buildPath}/index-min.js"; mv "${buildPath}/index-min.js" "${buildPath}/index.js" ; cp "${dirPath}/index.html" "${buildPath}/index.html"`, (stdout) => {
                console.log(`----------------------------------------`);
