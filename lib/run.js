      ...
      const commands = {
          serve: (options) => {
            return new Promise((resolve, reject) => {
              ...
              executeShellCommand(`rm -rf "${debugPath}"; mkdir "${debugPath}" ; node "${browserifyPath}" ${mainPath} > "${debugPath}/index.js" ; cp "${dirPath}/index.html" "${debugPath}/index.html"; cp "${dirPath}/style.css" "${debugPath}/style.css"`, (stdout) => {
                console.log(`----------------------------------------`);
